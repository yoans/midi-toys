...
class Application extends _react2.default.Component {
    ...
    render() {
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                'button',
                { id: 'mute-unmute', className: 'arrow-input', onClick: this.muteToggleHandler },
            ...
            _react2.default.createElement('input', { id: 'max-note-length', className: 'arrow-input', type: 'number', max: maxNoteLength, min: minNoteLength, value: this.state.noteLength, onChange: this.newNoteLengthHandler }),
            _react2.default.createElement(
                'label',
                { htmlFor: 'arrow-input-number', className: 'arrow-input-label' },
                'Size of Grid:'
            ),
            _react2.default.createElement('input', { id: 'arrow-input-number', className: 'arrow-input', type: 'number', max: maxSize, min: minSize, value: this.state.gridSize, onChange: this.newSizeHandler }),
            _react2.default.createElement(
                'label',
            ...
            this.state.playing ? _react2.default.createElement(
                'button',
                { id: 'play-stop', className: 'arrow-input', onClick: this.pauseHandler },
                'Stop'
            ) : _react2.default.createElement(
                'button',
                { id: 'play-stop', className: 'arrow-input', onClick: this.playHandler },
                'Start'
            ),
            _react2.default.createElement(
                'label',
...
function onMIDIInit(midi) {
    ...
    let nextOutput = outputsIterator.next();
    while (!nextOutput.done) {
        selectMIDIOut.add(new Option(nextOutput.value.name, nextOutput.value.id, false, false));
        nextOutput = outputsIterator.next();
    }
